...
@section('content')
    ...
    <div class="panel panel-primary filterable">
        <div class="panel-heading">
            <h3 class="panel-title"><a href="GestionLivres/create"><i class="fa fa-plus"></i> Add New Book</a></h3>
            ...
            @foreach( $fichier as $myficher)
                <tr>
                    ...
                    <td>@if($myficher->status == 0)
                            <a href="GestionLivres/{{ $myficher->id }}" class="btn btn-danger btn-xs"
                               title="Book Invalide">Invalide</a>
                        @else
                            <a class="btn btn-success btn-xs" title="Book Valide">Valide</a>
                        @endif</td>
                    <td><a href="GestionLivres/{{  $myficher->id }}/edit" class="btn btn-success btn-xs">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer ">
                                {!! Form::open(['method'=>'DELETE', 'route'=>['GestionLivres.destroy',$myficher->id]]) !!}
